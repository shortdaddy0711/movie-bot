...
The bot follows the ReAct cycle:

1.  **Reason**: "I need to find the cast for movie 550 to answer the user."
2.  **Act**: Call `get_movie_credits`.
3.  **Observe**: Receive the JSON list of actors.
4.  **Reason**: "I now have the list of actors. I can answer the user."
5.  **Output**: "Fight Club stars Edward Norton, Brad Pitt, and..."
